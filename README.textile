...
The codebase is being gradually upgraded to support Rails > 3.0.

Be sure to use the latest code of the rails-3 branch of "adapter_extensions":https://github.com/activewarehouse/adapter_extensions/tree/rails-3 if you use Rails 3+.
...
* run (for instance):
    ...
    @rake "ci:run_one[mysql,test/config/gemfiles/Gemfile.rails-3.0.x]"@
